...
2. Once you've created your javaScript objects, you will write the code needed to display all of the resume data contained within these objects in your resume. Your resume should be capable of displaying any resume that provides the data according to the given schema. Note that [**'forEach' or 'for'**](https://udacity.github.io/frontend-nanodegree-styleguide/javascript.html#for-in-loop) (rather than 'for in') loops must be used to display the **skills**, **jobs**, **projects**, project **images**, **schools** and **onlineCourses** arrays.  Make sure your solution works for any number of items in those arrays.
