...
2. Once you've created your javaScript objects, you will write the code needed to display all of the resume data contained within these objects in your resume. Note that [**forEach or for**](https://udacity.github.io/frontend-nanodegree-styleguide/javascript.html#for-in-loop) (rather than for in) loops must be used to display the **skills**, **jobs**, **projects**, projects **images**, **schools** and **onlineCourses** arrays. You resume should be capable of displaying any number of items in those arrays.
